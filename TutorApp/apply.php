...
<head>
    ...
    <title>Apply To become a Tutor</title>
...
<body>
    ...
    <section class="request">
        <h1>Apply To be a Tutor Today!</h1>
        <form class="form1" action="apply.php" method="post">
            ...
            <label for="contact-phone-no">Cell Number*</label>
            <input id="contact-phone-no" type="tel" maxlength="256" required name="phone">

            <label for="subject" class="subject">Subject*</label>
            <input id="subject" type="text" maxlength="256" required placeholder="Subject you would like to tutor" name="subject">
            ...
            <textarea id="message" value="message" maxlength="5000" cols="30" rows="10" required
                placeholder="if you wish to tutor multiple subjects please state so here. Please also provide a brief description on why you would make a great tutor" name="message"></textarea>
