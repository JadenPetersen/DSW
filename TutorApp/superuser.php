...
<div class="dashbut">
    <a href="Admin_register.php"><button class="butt" >CREATE ADMINS</button></a>
    <a href="super_tutor_reg.php"><button class="butt" >CREATE TUTORS</button></a>
    <a href="superuser_admins.php"><button class="butt" >DISPLAY ADMINS</button></a>
    <a href="superuser_tutors.php"><button class="butt" >DISPLAY TUTORS</button></a>
</div>
<div>
    <footer class="footer">
        <nav class="navbar">
